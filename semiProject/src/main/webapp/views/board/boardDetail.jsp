...
<form id="detail-form">
 <input type="hidden" name="b_idx" value="${board.b_idx}">
            ...
            <div class="row row1">
             <table class="table">
               <tr>
                ...
                <td width=30% class="text-center">${b_row}</td>
                <th width=20% class="text-center warning">작성일</th>
                <td width=30% class="text-center">${board.b_inDate}</td>
               </tr>
               <tr>
                <th width=20% class="text-center warning">작성자</th>
                <td width=30% class="text-center">${board.m_nickname}</td>
                <th width=20% class="text-center warning">조회수</th>
                <td width=30% class="text-center">${board.b_views}</td>
               </tr>
               <tr>
               ...
               <tr>
                <th width=20% class="text-center warning">내용</th>
                 <td colspan="4" class="text-left" valign="top" height="280">
                  <pre style="white-space: pre-wrap;border:none;background-color: white;">${board.b_content}</pre>
                 </td>
               </tr>
    ...
    <button type="button" onclick="boardUpdate(${board.b_idx},${b_row})" class="btn-s btn-s-dark">수정</button>
    <button type="submit" onclick="boardDelete()" style="background-color: rgb(159, 38, 38);" class="btn-s btn-s-dark">삭제</button>
