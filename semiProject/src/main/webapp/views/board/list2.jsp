    ...
    <section class="notice left2">
        <div class="page-title">
          ...
          <main role="main" class="container">
            <form name="form" action="/boardEnroll.do" method="POST" enctype="multipart/form-data">
                <div class="container page-title">
                    <h3 style="font-size: 30px;">TITLE</h3>
                </div>
                <div class="pt-1"></div>
                    <input type="text" name="b_title" placeholder="제목을 입력하세요" style="border-radius:5px; width:100%; padding:5px; background-color: #f9f7f9;">
                </div>
                <div class="container page-title">
                ...
                <div class="pt-1 text-right">
                    ...
                    <button class="btn-s btn-s-dark">작성</button>
                    <button class="btn-s btn-s-dark" type="reset" onclick="window.location.href = '/boardList.do?cpage=1'">취소</button>
                </div>    
            </form>
        </main>
