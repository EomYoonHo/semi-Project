...
<html lang="en-us">
    ...
    <section class="notice left2">
        <div class="page-title">
          ...
          <div id="board-list">
              <div class="container">
                <form action="/boardEnroll.do" class=" form-horizontal" method="POST" enctype="multipart/form-data" th:action="@{/post}" th:object="${postDto}">
                    <div class="form-group">
                        <label>제목</label>
                        <div class="col-sm-12">
                            <input type="text" name="b_title" class="form-control" th:field="*{title}" placeholder="제목을 입력해 주세요."/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label>내용</label>
                        <div class="col-sm-12">
                            <textarea class="form-control" name="b_content" style="height: 300px;" th:field="*{content}"
                                      placeholder="내용을 입력해 주세요."></textarea>
                        </div>
                    </div>
        
                    
                    <button style="margin: 20px; margin-left: 0px;" class="btn-s btn-s-dark">작성</button>
