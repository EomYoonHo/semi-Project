...
<html lang="en-us">
    ...
    <section class="notice left2">
        <div class="page-title">
              <div class="container">
                  <h3 style="font-size: 50px;">Community</h3>
              </div>
          </div>
 ...
 <input type="hidden" name="b_idx" value="${board.b_idx}">
            ...
            <div class="row row1">
             <table class="table">
               <tr>
                ...
                <td width=30% class="text-center"><input class="minsu" type="text" value="${b_row}" disabled></td>
                <th width=20% class="text-center warning">작성일</th>
                <td width=30% class="text-center"><input class="minsu" type="text" value="${board.b_inDate}" disabled></td>
               </tr>
               <tr>
                <th width=20% class="text-center warning">작성자</th>
                <td width=30% class="text-center"><input class="minsu" type="text" value="${board.m_nickname}" disabled></td>
                <th width=20% class="text-center warning">조회수</th>
                <td width=30% class="text-center"><input class="minsu" type="text" value="${board.b_views}" disabled></td>
               </tr>
               <tr>
                <th width=20% class="text-center warning">제목</th>
                <td colspan="3"><input name="b_title" id="b_title" class="minsu" type="text" value="${board.b_title}"></td>
               </tr>
               <tr>
                <th width=20% class="text-center warning">내용</th>
                 <td colspan="4" class="text-left" valign="top">
                  <textarea class="minsu" style="height: 230px;" name="b_content" id="b_content" cols="30" rows="10">${board.b_content}</textarea>
                 </td>
               </tr>
    ...
    <button type="reset" onclick="window.location.href = '/boardList.do?cpage=1'" class="btn-s btn-s-dark">취소</button>
 </form>
