...
<!-- 잡것 -->
 ...
 <input type="hidden" name="b_idx" value="${board.b_idx}">
            ...
            <div class="container">
             <table class="board-table">
               <tr>
                ...
                <td width=30% class="text-center www"><input class="ct bs" type="text" value="${b_row}" disabled></td>
                <th width=20% class="text-center warning">작성일</th>
                <td width=30% class="text-center www"><input class="ct bs" type="text" value="${board.b_inDate}" disabled></td>
               </tr>
               <tr>
                <th width=20% class="text-center warning">작성자</th>
                <td width=30% class="text-center www"><input class="ct bs" type="text" value="${board.m_nickname}" disabled></td>
                <th width=20% class="text-center warning">조회수</th>
                <td width=30% class="text-center www"><input class="ct bs" type="text" value="${board.b_views}" disabled></td>
               </tr>
               <tr>
                <th width=20% class="text-center warning">제목</th>
                <td colspan="3" width=30% class="text-center www"><input name="b_title" id="b_title" class="ct bs" type="text" value="${board.b_title}"></td>
               </tr>
               <tr>
    ...
    <button type="submit" class="btn-s btn-s-dark">수정</button>
