...
<html lang="en-us">
    ...
    <!-- ㅇㅇ -->
    <div class="hero-header left5"></div>
            ...
            <nav class="navigation border--bottom pt1">
              ...
              <a href="./register.html" class="link link--text">회원가입</a>
                ...
                <a href="./list.html" class="link link--text">게시판<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-card-list" viewBox="0 0 16 16">
                  ...
                  <a href="./orderList.html" class="link link--text current">여행 패키지<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-airplane" viewBox="0 0 16 16">
