    ...
    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
                    ...
                    <div id="board-list">
                        <div class="container">
                            <table class="board-table">
                                ...
                                <tr>
                                    <th width=20% class="text-center warning" style="text-align: center;">주문번호</th>
                                    <td colspan="3" width=30% class="text-center www">${orderDTO.o_idx}
                                        <b>번</b>
                                    </td>
                                </tr>
                                <tr>
                                    <th width=20% class="text-center warning" style="text-align: center;">구매자 이름</th>
                                    <td colspan="3" width=30% class="text-center www">${orderDTO.o_buyer_name}</td>
                                </tr>
                                <tr>
                                    <th width=20% class="text-center warning" style="text-align: center;">상품이름</th>
                                    <td colspan="3" width=30% class="text-center www">${orderDTO.o_name}</td>
                                </tr>
                                <tr>
                                    <th width=20% class="text-center warning" style="text-align: center;">상품가격</th>
                                    <td colspan="3" width=30% class="text-center www" id="p_price"
                                        style="font-weight: bold;">
                                    </td>
                                </tr>
                                <tr>
                                    <th width=20% class="text-center warning" style="text-align: center;">예약인원</th>
                                    <td colspan="3" width=30% class="text-center www">${orderDTO.o_people}<b>명</b></td>
                                </tr>
                                <tr>
                                    <th width=20% class="text-center warning" style="text-align: center;">사용한 포인트</th>
                                    <td colspan="3" width=30% class="text-center www">${selectPM.pm_amount}<b>point</b>
                                    </td>
                                </tr>
                                <tr>
                                    <th width=20% class="text-center warning" style="text-align: center;">추가된 포인트</th>
                                    <td colspan="3" width=30% class="text-center www">+
                                        ${orderDTO.o_point}<b>point</b>
                                    </td>
                                </tr>
                                <tr class="iipp6">
                                    <th width=20% class="text-center warning" style="text-align: center;">결제 금액</th>
                                    <td colspan="3" width=30% class="text-center www" id="o_paid_amount"
                                        style="font-weight: bold;">
                                    </td>
                                </tr>
                            </table>
        ...
        <script>
            ...
            function formatPrice() {
                let Pprice = ${ packageDTO.p_price };
                let formattedPprice = formatNumber(Pprice);
                document.getElementById("p_price").innerHTML = formattedPprice + "원";
                let paidAmount = ${ orderDTO.o_paid_amount };
                let formattedpaidAmount = formatNumber(paidAmount);
                document.getElementById("o_paid_amount").innerHTML = formattedpaidAmount + "원"
            }
