<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
            ...
            <div class="container wsmm">
                ...
                <div class="iipp2">
                    <div class="productdetail dfjc">
                        <span>기간</span> <select class="www pgc pptt" name="period" id="period" onclick="choosePeriod()">
                    ...
                    <div class="productdetail dfjc">
                        <span>1인가격</span> <span id="p_price"></span>
                    </div>
                    <div class="productdetail dfjc">
                        <span>인원수</span> <input class="minsu2 pts" type="number" onclick="multiplication()"
                            onkeyup="multiplication()" id="mulkey" style="background-color: white; width: 5%;" min="1">
                    </div>
                    <div>
                        <div class="productdetail dfjc">
                    ...
                    <div class="productdetail dfjc">
                        <span>포인트 사용</span> <input class="minsu2" type="number" id="pointUse"
                            value="${PointBalance.p_balance}" style="background-color: white;" disabled>
        ...
        <script>
            ...
            function formatPprice() {
                let Pprice = ${ pack.p_price };
        ...
        <script type="text/javascript">
            ...
            function multiplication() {
                ...
                let Tprice = mulkey * ${ pack.p_price };
                let formattedTprice = formatNumber(Tprice);
                totalPrice.innerHTML = formattedTprice + "원";
                let payPrice = document.getElementById("payPrice");
                let PAprice = mulkey * ${ pack.p_price };
                let formattedPAprice = formatNumber(PAprice);
                payPrice.innerHTML = formattedPAprice + "원";
            ...
            function pointUse() {
                ...
                let payPrice = document.getElementById("payPrice");
                let priceMinusPoint = (mulkey * ${ pack.p_price }) - point;
                let formattedpriceMinusPoint = formatNumber(priceMinusPoint);
                payPrice.innerHTML = formattedpriceMinusPoint + "원";
