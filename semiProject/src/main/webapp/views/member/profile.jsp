...
<form action="" id="profile-detail">          
    ...
    <button style="background-color: rgb(159, 38, 38);" class="btn-s btn-s-dark" onclick="delete()">회원탈퇴</button>
    <button class="btn-s btn-s-dark" formaction="./map.html">취소</button>
        ...
        <div class="body full-width pt1 pr2 pb2 pl2">
            ...
            <footer class="border--top pt1 pb1">
                <img src="/resources/img/mm.jpg" alt="group">
