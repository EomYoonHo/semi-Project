	...
	<div class="container">
		...
		<div class="left2">
			<div class="product-list">
				<div class="slider">
					<div class="slide img">
						<img src="/resources/img/1.jpg" alt="이미지 1">
					</div>
					<div class="slide img">
						<img src="/resources/img/2.jpg" alt="이미지 1">
					</div>
					<div class="slide img">
						<img src="/resources/img/3.jpg" alt="이미지 1">
					</div>
				</div>
			</div>
		</div>
		...
		<div id="fifth">
			<div>
				<p class="packagename">${tourinfo.p_no}</p>
				<p class="packagename2">${tourinfo.p_name}</p>
			</div>
			<div id="heart2">
		...
		<p class="detail left2">
		<div class="productdetail left2">
			<span>가격</span> <span> ${tourinfo.p_price} </span>
		</div>
		<div class="productdetail left2">
			<span>구매자</span> 
			<span> 구매자 no:${memberinfo.m_no} <br>
						구매자 이름:${memberinfo.m_name} <br> 
						구매자 닉네임:${memberinfo.m_email}
			</span>
		</div>
	...
	<div class="grid-row">
		...
		<div class="body full-width pt1 pr2 pb2 pl2">
			...
			<nav class="navigation border--bottom pt1">
				<a href="#" class="link link--text left">로그인</a> <a href="#"
					class="link link--text">회원가입</a>
			</nav>
			<nav class="navigation border--bottom pt1">
				<a href="#" class="link link--text">지도<svg
                  ...
                  </svg></a> <a href="/views/tourGoods/orderList.jsp"
					class="link link--text current">여행 패키지<svg
						xmlns="http://www.w3.org/2000/svg" width="16" height="16"
