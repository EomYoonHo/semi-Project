...
<body>
  ...
  <form id = "detail-form"> 
               ...
               <tr>
                <th width=20% class="text-center warning">내용</th>
                 <td colspan="4" class="text-left www" valign="top" height="280">
                  <pre style="white-space: pre-wrap;border:none;background-color: white; font-size:20px ;">${reviewboard.content}</pre>                
                 </td>
               </tr>
    ...
    <button class="custom-btn btn-6" onclick="window.location.href='/reviewBoardList.do?cpage=1'">취소</button>
	</div>
</form>               
</section>
<div class="page-title">
