	...
	<div class="grid-row">
		...
		<div class="hero-container full-width show-on-mobile pt1 pl2 pr2">
			<div class="hero full-width full-height"
				style="background: rgba(0, 0, 0, 0) url(./img/mm.jpg) no-repeat scroll center center/cover"></div>

		</div>
		<div class="hide-on-mobile hero"
			style="background: rgba(0, 0, 0, 0) url(/resources/image/img6.jpg) no-repeat scroll center center/cover"></div>
		...
		<div class="body full-width pt1 pr2 pb2 pl2">
			...
			<nav class="navigation border--bottom pt1">
				<ul class="no-bullets list--inline pb1 bold">
					<li class="small mr2"><a class="link link--text current"
						href="./FIRST.html">FIRST</a></li>
					<li class="small mr2"><a class="link link--text"
						href="./SECOND.html">SECOND</a></li>
					<li class="small mr2"><a class="link link--text"
						href="./THIRD.html">THIRD</a></li>
					<li class="small"><a class="link link--text"
						href="./FOURTH.html">FOURTH</a></li>
				</ul>
			</nav>
			<!-- Page Content -->
			...
			<nav class="navigation border--bottom pt1">
				...
				<script>
					function myMap() {
						var mapOptions = {
							center : new google.maps.LatLng(48.857977, 2.295189),
							zoom : 15
						};
						...
						var marker = new google.maps.Marker({
							position: new google.maps.LatLng(48.857977, 2.295189),
							map: map
						});
					}
				</script>
