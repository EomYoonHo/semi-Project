<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
        ...
        <head>
            ...
            <link type="text/css" rel="stylesheet" href="cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js">
            <!-- Custom stlylesheet -->
            <!-- Google font -->
        ...
        <body>
            ...
            <main class="th-layout-main">
                ...
                <!-- dd -->
                <div class="glamping-N5" data-bid="KmLpj5JFIP" style="padding: 0; margin: 0;">
                    <div class="contents-inner" style="padding: 0;">
                        <div class="contents-container container-md">
                            <div class="cardset-wrap">
                                <div class="cardset cardset-hor">
                                    <!-- 티켓 -->
                                    <div class="cardset-body"
                                        style="width: 30%; padding-left: 50px; padding-right: 300px;">
                                        ...
                                        <div class="boarding-pass link-7">
                                            ...
                                            <section class="cities">
                                                <div class="city">
                                                    <small>${korean_start}</small>
                                                    <strong>${ariLineDTO.at_starting_point}</strong>
                                                </div>
                                                <div class="city">
                                                    <small>${korean_destination}</small>
                                                    <strong>${ariLineDTO.at_destination}</strong>
                                                </div>
                                                <svg class="avgam" style="width: 20%;">
                                                    <use href="#airplane" />
                                                </svg>
                                            </section>
                                            <section class="infos">
                                            ...
                                            <section class="strap">
                                                <div class="box">
                                                    ...
                                                    <div class="date">
                                                        <small>Date</small>
                                                        <strong>${ariLineDTO.at_godate}</strong>
                                                        <strong>${ariLineDTO.at_backdate}</strong>
                                                    </div>
                                                </div>
                                                <svg class="qrcode">
                  ...
                  68,123 73,123 73,118  " />
                                    ...
                                    <!-- 영수증 -->
                                    <div class="cardset-body dfjc" style="width: 60%;">
                                                        ...
                                                        <div class="container" style="width: 60%;">
                                                            <table class="board-table ">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width=10% class="text-center www">
                                                                        <b> ${korean_start}-${korean_destination}</b>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th width=10% class="text-center warning"
                                                                    ...
                                                                    <td width=10% class="text-center www">
                                                                        <b>
                                                                            ${ariLineDTO.at_godate}~${ariLineDTO.at_backdate}</b>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th width=10% class="text-center warning"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width=10% style="font-weight: bold;"
                                                                        class="text-center www" id="at_price_per">
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <th width=10% class="text-center warning"
                                                                    ...
                                                                    <td width=10% class="text-center www">
                                                                        <b> ${ariLineDTO.at_people}</b> <b>명</b>
                                                                    </td>
                                                                </tr>
                                                                <tr class="iipp6">
                                                                    <th width=10% class="text-center warning"
                                                                    ...
                                                                    <td width=10% style="font-weight: bold;"
                                                                        class="text-center www" id="at_all_price">
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                            <div class="dfjc">
        ...
        <script>
            ...
            function priceFormat() {
                let onePeoplePrice = ${ ariLineDTO.at_price_per };
                let formattedOnePeoplePrice = formatNumber(onePeoplePrice);
                let allPrice = ${ ariLineDTO.at_all_price };
                let formattedAllPrice = formatNumber(allPrice);
                document.getElementById("at_price_per").innerHTML = formattedOnePeoplePrice + "원";
                document.getElementById("at_all_price").innerHTML = formattedAllPrice + "원";
            }
