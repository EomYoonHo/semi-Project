    ...
    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
        ...
        <body>
            ...
            <main class="th-layout-main ">
                ...
                <!-- dd -->
                <div class="glamping-N5" data-bid="KmLpj5JFIP" style="padding-top: 0px; padding-bottom: 0px;">
                    <div class="contents-inner">
                        <div class="contents-container container-md">
                            <div class="cardset-wrap">
                                <!-- 대한항공 -->
                                <div class="cardset cardset-xl cardset-deco cardset-hor row-rever bborder">
                                    <!-- 항공편 테이블 -->
                                                ...
                                                <div class="item_course">
                                                    <span class="time dfjc"><b>${airlineDTO.at_godate}</b>&nbsp;&nbsp;
                                                        <span class="city"><b>${airlineDTO.at_starting_point}
                                                                - ${airlineDTO.at_destination}</b></span></span> <span
                                                        class="move_arrow">
                                                        <p class="wait">
                                                            <span class="tooltip text">경유 1회</span>
                                                        </p> <br>
                                                        <p class="load dfjc">
                                                            <img class="isize" src="/resources/image/티켓plane.png"
                                                                alt="">
                                                        </p>
                                                    </span> <br> <span
                                                        class="time dfjc"><b>${airlineDTO.at_backdate}</b>&nbsp;&nbsp;
        ...
        <script type="text/javascript">
            ...
            function BillAsiana() {
                ...
                let aPrice = Math.ceil(1.1 * ${ airlineDTO.at_all_price });
                let formattedAsiana = formatNumber(aPrice);
                asiana.innerHTML = formattedAsiana;
            }
            function BillJinAir() {
                let jinAir = document.getElementById("jinAir");
                let jPrice = Math.ceil(1 * ${ airlineDTO.at_all_price });
                let formattedJinAir = formatNumber(jPrice);
                jinAir.innerHTML = formattedJinAir;
            }
            function BillKorea() {
                let korea = document.getElementById("korea");
                let kPrice = Math.ceil(1.04 * ${ airlineDTO.at_all_price });
                let formattedKorea = formatNumber(kPrice);
                korea.innerHTML = formattedKorea;
            }
