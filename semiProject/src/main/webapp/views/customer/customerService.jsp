					...
					<div class="cardset cardset-xl cardset-deco cardset-hor row-rever">
							...
							<section class="notice">
								...
								<form action="" id="customer-detail">
									...
									<div class="pt-1 wwwii dfjc">
										<a href="/views/customer/customerEnroll.jsp">
						...
						<div class="cardset-body" style="width: 30%;">
							...
							<div class="faq-container">
								<div class="faq">
									<h3 class="faq-title">신혼여행상품 예약은 언제쯤부터 <br> 해야 하나요?</h3>
								...
								<div class="faq">
									<h3 class="faq-title">항공권 예약 문의는 어느 곳에서<br> 해야 하나요?</h3>
								...
								<div class="faq">
									<h3 class="faq-title">패키지여행으로 예약하고 현지에서<br> 일행끼리 관광이 되나요?</h3>
								...
								<div class="faq">
									<h3 class="faq-title">자유여행을 가려하는데요.<br> 조언 좀 해주세요.</h3>
