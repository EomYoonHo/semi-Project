...
<section class="notice left5">
	...
	<form action="">
		<div id="board-list">
			<div class="container">
				<table class="board-table">
					...
					<thead>
						<tr>
							<th scope="col" class="th-title ff">패키지</th>
							<th scope="col" class="th-title ff">가격</th>
							<th scope="col" class="th-title ff">기간</th>
							<th scope="col" class="th-title ff">예약자</th>
							<th scope="col" class="th-title ff">구매날짜</th>
						</tr>
					</thead>
					...
					<c:choose>
						...
						<td><a href="">미동부 패키지</a>${item.o_name}</td>
						<td>19,999,999${item.o_paid_amount}</td>
						<td>2023-11-22 ~ 2023-12-22${item.o_period}</td>
						<td>hand민수${item.o_buyer_name}</td>
						<td>2023-11-11${item.o_paid_at}</td>
		...
		<button class="btn-s btn-s-dark" formaction="myPage.html">취소</button>
	...
	<nav class="navigation border--bottom pt1">
		<a href="map.html" class="link link--text">지도<svg
				...
				fill="currentColor" class="bi bi-card-list" viewBox="0 0 16 16">
                  ...
                  </svg></a> <a href="./orderList.html" class="link link--text">여행
			패키지<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
